...
public class UserAddRemoveTrainDeparture {
  ...
  public void userRemoveDeparture() {
    ...
    if (trainDepartureRemoved) {
      System.out.println(TrainDispatchAppUi.GREEN + "Train departure removed" + TrainDispatchAppUi.COLOR_RESET);
    } else {
  ...
  public void userAddDeparture() {
    ...
    while (trainNumber < 1 || trainNumber > 99) {
      System.out.println(TrainDispatchAppUi.RED + "Train number must be between 1 and 99" + TrainDispatchAppUi.COLOR_RESET);
      System.out.println();
    ...
    while (trainTrack > 100 || trainTrack < 1) {
      System.out.println(TrainDispatchAppUi.RED + "Track number must be between 1 and 99" + TrainDispatchAppUi.COLOR_RESET);
      System.out.println();
    ...
    if (!departureAdded) {
      ...
      System.out.println(TrainDispatchAppUi.GREEN + "Train departure added successfully" + TrainDispatchAppUi.COLOR_RESET);
    }
    System.out.println();
    System.out.println("Press enter to return to main menu");
    Scanner scanner = new Scanner(System.in);
